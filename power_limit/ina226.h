...
#define INA226_CONFIG 	0x00 // Configuration Register (R/W)???4127
#define INA226_SHUNTV 	0x01 // Shunt Voltage (R)???0,???????
#define INA226_BUSV 	0x02 // Bus Voltage (R)???0,???????
#define INA226_POWER 	0x03 // Power (R)???0,???????
#define INA226_CURRENT 	0x04 // Current (R)???0,?????????
#define INA226_CALIB 	0x05 // Calibration (R/W),????????LSB
