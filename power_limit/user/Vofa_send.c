...
Vofa_data_m_3 Vofa_data_3={.tail={0x00,0x00,0x80,0x7f}};
...
void Vofa_Send_Data3(float data1, float data2,float data3)
{
	Vofa_data_3.ch_data[0] = data1;
	Vofa_data_3.ch_data[1] = data2;
    Vofa_data_3.ch_data[2] = data3;
	HAL_UART_Transmit_DMA(&VOFA_HUART, (uint8_t *)&Vofa_data_3, sizeof(Vofa_data_3));   
}
...
void Vofa_Send_Data4(float data1, float data2,float data3, float data4)
{
	...
	HAL_UART_Transmit_DMA(&VOFA_HUART, (uint8_t *)&Vofa_data_4, sizeof(Vofa_data_4));   
}
