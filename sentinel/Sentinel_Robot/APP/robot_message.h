...
typedef struct __attribute__((packed))
{
	INS_CAN_send_t INS_send;
	
}CAN_send_NX_t;

typedef struct __attribute__((packed))
{
	INS_CAN_receive_t INS_receive;
...
extern CAN_send_NX_t CAN_Transmit_NX;
extern CAN_receive_NX_t CAN_Receive_NX;
...
extern void CAN_send_NX();
extern void CAN_data_update();

extern enemy_state_data_t enemy_state_data[6];
