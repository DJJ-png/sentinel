...
void INS_Task(void const *pvParameters)
{
    ...
    imu_start_dma_flag = 1;
		...
		bmi088_offset_data.gyro[0] =-0.00378840626;//-0.0035928716;// -0.00488316454;
		bmi088_offset_data.gyro[1] =-0.00131808233;//-0.00121286255;//-0.00137732935;
		bmi088_offset_data.gyro[2] =0.00253779767;//0.00275532948;//0.00239972677;
//		mpu_offset_clc();
    ...
    while (1)
    {
        ...
        accel_fliter_3[2] = accel_fliter_2[2] * fliter_num[0] + accel_fliter_1[2] * fliter_num[1] + INS_accel[2] * fliter_num[2];
			...
			INS_angle_deg[BASE_YAW] = INS_angle[0] * 180.0f / 3.141592653589f;
			INS_angle_deg[PITCH] = INS_angle[1] * 180.0f / 3.141592653589f;
			INS_angle_deg[ADVANCED_YAW] = INS_angle[2] * 180.0f / 3.141592653589f;
...
/**
  * @brief          get the rotation speed, 0:x-axis, 1:y-axis, 2:roll-axis,unit ra  d/s
  * @param[in]      none
